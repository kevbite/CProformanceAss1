...
static const std::string* markTextTable[] = 
{
  ...
  &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &RED_TEXT, &AMBER_TEXT,
  &AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT,&AMBER_TEXT, &GREEN_TEXT,
